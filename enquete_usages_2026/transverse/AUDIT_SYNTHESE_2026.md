...
| 509 site-only · 75 % datés 2026 | 🟡 | Exact (380/509). Borne haute (70 appariements cachés). Récence en partie artefact de la fenêtre de tracking (27 nov.). |
...
*Audit produit le 21 juin 2026. Tous les re-calculs sont reproductibles depuis `transverse/data/`, `usage-capytale/data/`, `site-vers-classe/data/` (pseudonymisés). Aucune donnée personnelle.*
