...
- MASTER (one row per teacher who taught, n=224): ${ROOT}/transverse/data/master_teachers.csv
  Columns:
...
- sessions (738 teaching sessions): ${ROOT}/usage-capytale/data/sessions.csv  [session_id, teacher, mathadata_id, act_label, uai_el, n_eleves, start, end, sy, date, span_min]
- usages_enriched (per-row, incl. tests where role!=student): ${ROOT}/usage-capytale/data/usages_enriched.csv
- engaged_teachers (401 = 224 a_enseigne + 140 stagiaire_seul + 37 testeur_distributeur): ${ROOT}/usage-capytale/data/engaged_teachers.csv
- volet2 facts: ${ROOT}/site-vers-classe/data/facts_cross.json , facts_formation.json , cohorts.csv , presentiel_etabs.csv , match_candidates.csv (70 individual site<->capytale pairs)
