...
**67 paires** site ↔ Capytale (23,9 % des 280 cliqueurs site à UAI connu) : **44 de confiance A** (timing clic→clone serré, ou déploiement direct corroboré par l'activité), **23 de confiance B** (unicité UAI 1:1). Sur ces 67 : **47 s'étaient testés, 20 ont déployé sans test** (« plongée directe »), **53 (79 %) ont atteint une classe** (1 384 élèves), 28 ont réutilisé (≥2 séances), 19 ont diffusé ≥2 activités, 4 sur deux années. *(L'appariement récupère désormais les profs « plongée directe » sans clone-test ; cf. correctif matcher.)*
...
- **Aucun identifiant commun.** Appariement individuel inféré (67 paires, dont 44 confiance A) ; grain robuste = établissement + cohorte. 13/67 paires ont une causalité inversée (clone avant clic site).
