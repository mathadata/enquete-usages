...
**70 paires** site ↔ Capytale (25,0 % des 280 cliqueurs site à UAI connu) : **46 de confiance A** (déploiement corroboré par l'activité, ou timing clic→auto-test serré), **24 de confiance B** (unicité UAI 1:1). L'appariement **priorise le déploiement** (signaux E=34, D=17) sur l'**auto-test** (A=9) — car le clic mène à la page cloner→partager aux élèves, pas à l'auto-test — et **écarte** les 10 paires signal-A à établissement **multi-collègues** (l'auto-testeur y est souvent un collègue ; renvoyées en `proxy_etab`, jamais nominatives). Sur ces 70 : **41 s'étaient auto-testés, 29 en plongée directe**, **59 ont touché des élèves (≥3 él.), dont 50 une classe ≥5** (1 663 élèves), **21 en usage multiple** (≥2 occasions), 21 ont diffusé ≥2 activités, 5 sur deux années.
...
- **Aucun identifiant commun.** Appariement individuel inféré (70 paires, dont 46 confiance A) ; grain robuste = établissement + cohorte. 13/70 paires ont un usage Capytale antérieur au contact site (canal Capytale-direct = causalité « site→classe » inversée).
