...
const THEMES = [
  { key:'pipeline_funnel', title:'Le pipeline complet, de la notoriete a la classe',
    brief:`Construis le funnel de bout en bout en combinant site + Capytale : comptes crees (analysé 2715 / brut 2724, dont 1003 newsletter_only) -> comptes complets (1712) -> formes (631) -> ont clique vers Capytale (337) [marches NON strictement emboitees : 188 des 631 formes sont newsletter-only, ne pas chainer 1712->631] -> ont teste sur Capytale -> ont enseigne a des eleves (volet1: 224 / 5854 eleves) -> re-usage. Quantifie chaque marche et chaque fuite. Mesure le funnel SITE propre sur la cohorte trackable (apres 27 nov 2025). Calcule les delais compte->1ere action (module/ressource/capytale). Distingue clairement ce qui est mesure cote site (intention) vs cote Capytale (usage reel). Cadre le tout avec le garde-fou tracking.` },
