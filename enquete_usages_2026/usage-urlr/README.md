...
5. `charts/05_seances_urlr_vs_capytale.png` — séances de taille classe estimée vs Capytale ;
6. `charts/06_modes_remplacement_depannage.png` — classification stricte et sensibilité ±1 h ;
