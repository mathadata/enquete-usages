...
- Page web : `usage-capytale/dashboard.html` → https://akimx98.github.io/mathadata-dashboard-next/volet1.html
...
- Page web : `site-vers-classe/dashboard_volet2.html` → https://akimx98.github.io/mathadata-dashboard-next/volet2.html
...
- Page web (canonique) : `transverse/dashboard_typologie.html` → https://akimx98.github.io/mathadata-dashboard-next/typologie.html
