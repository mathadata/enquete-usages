...
OUT=f"{BASE}/commons/data"

S=pd.read_csv(f"{BASE}/volet1/data/sessions.csv")
U=pd.read_csv(f"{BASE}/volet1/data/usages_enriched.csv")
...
T=pd.read_csv(f"{BASE}/volet1/data/teachers.csv")[['teacher','uai','academie','commune','ips','n_prof_uai' if False else 'uai']]
...
TT=pd.read_csv(f"{BASE}/volet1/data/teachers.csv")
TT=TT[TT['taught']==True].copy()
