...
Implémente *strictement* `commons/GLOSSAIRE.md` (source de vérité des définitions).
...
ENTRÉES (déjà canoniques) :
  - volet1/data/usages_enriched.csv, sessions.csv, teachers.csv   (Capytale, versionné)
  - volet2/data/match_candidates.csv                             (75 paires, versionné, sans PII)
...
SORTIES (PII-free, versionnées dans commons/data/) :
...
V1   = f"{ROOT}/enquete_usages_2026/volet1/data"
V2   = f"{ROOT}/enquete_usages_2026/volet2/data"
OUT  = f"{ROOT}/enquete_usages_2026/commons/data"
