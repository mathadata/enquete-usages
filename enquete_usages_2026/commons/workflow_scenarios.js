...
- SCENARIOS (1 row/teacher, n=224): ${ROOT}/commons/data/scenarios_teachers.csv
...
- SESSIONS (1 row/session, n=738): ${ROOT}/commons/data/sessions_enriched.csv
  cols: pseudo, arch, scenario, mathadata_id, act_label, n_eleves, date, hour, wd (0=Mon..6=Sun), slot, span_min, sy.
- MASTER (retention/entry detail, n=224): ${ROOT}/commons/data/master_teachers.csv (pseudo-keyed, SAME pseudonyms as scenarios).
- facts_scenarios.json, facts_typologie.json, facts_investigation.json in ${ROOT}/commons/data/
- Formation/geo context: ${ROOT}/volet2/data/cohorts.csv , presentiel_etabs.csv , facts_cross.json
- Raw (pupil-level, teacher = HASH not pseudo — use only for aggregate reprise/home, not case ids): ${ROOT}/volet1/data/usages_enriched.csv
